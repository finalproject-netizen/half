...
const testimonials = [
  {
    ...
    name: 'A-Q',
    role: 'Pendidik',
    content: 'Memudahkan dalam akses teknologi pada perangkat pembelajaran.',
  ...
  },
  {
    ...
    name: 'N-F',
    role: 'Calon Pendidik',
    content: 'Memiliki nilai jual dan guna pada produk, memotivasi saya membuat banyak produk.',
  ...
  },
  {
    id: 3,
    name: 'A-J',
    role: 'Pendidik Terverifikasi',
    content: 'Intergasi yang tepat dengan membuat Layanan yang memiliki timbal balik keberlanjutan.',
  ...
  },
  {
    ...
    name: 'A-G',
    role: 'Peserta didik',
    content: 'Memiliki permainan yang menyenangkan dalam pembelajaran.',
  ...
  },
  {
    ...
    name: 'M-M',
    role: 'Peserta didik',
    content: 'Gambarnya membuat saya tertarik untuk mengikuti pembelajaran.',
  ...
  },
  {
    ...
    name: 'V-M',
    role: 'Peneliti',
    content: 'layanan ini memiliki manfaat bagi peneliti dan yang sedang ingin meneliti serta mengembangkan produk.',
      ...
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-center mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight uppercase max-w-lg">
            Mereka yang <span className="text-accent-purple">berpendapat</span> tentang produk
          </h2>
