      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-left md:text-center"> {/* Responsive alignment */}
          ...
          >
            ...
            <span className="text-sm text-[#c5b8ff] uppercase">Layanan Penyebaran Berkelanjutan Produk Pendidikan</span>
          </motion.div>
          ...
          >
            Perbaiki Pendidikan
            <span className="block text-accent-purple">Untuk Semua</span>
          </motion.h1>
          ...
          >
            Mewadahi produk pendidikan dalam satu layanan terintegrasi sehingga dapat disebarluaskan dan memiliki keberlanjutan antara timbal balik dan nilai guna.
          </motion.p>
